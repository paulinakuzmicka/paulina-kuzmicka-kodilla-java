...
public class ForumUserTestSuite {
    ...
    public void testGetLocationsOfFriendsOfFriends(){
        ...
        Assert.assertEquals(4, user1.getLocationsOfFriendsOfFriends().size());
        ...
        Assert.assertTrue(user1.getLocationsOfFriendsOfFriends().contains("Orlando"));
        Assert.assertFalse(user1.getLocationsOfFriendsOfFriends().contains("Warszawa"));
    }
}
